...
class YoutubeData {
  static List<YoutubeDomain> lista_yt = [
    YoutubeDomain(
      ...
      texto: 'Ministradas pelo propfessor Virgílio, as aulas do canal "ABF - AstroBioFísica" para astonomia, guiam o aluno desde os conceitos básicos da astronomia até demonstrações de fórmulas da astrofísica. É uma excelente opção para os que desejam se aventurar nas oimpíadas de astronomia, em especial a OBA e as seletivas para as olipíadas internacionais de astronomia.', 
  ...
  static List<YoutubeDomain> getYoutube() {
    return lista_yt;
  }
}
